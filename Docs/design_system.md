...
| Role | Hex |
|---|---|
| Screen / status bar background | `#02010f` |
| Header / top bar / toolbar background | `#0c0d15` |
| Editor content surface / gutter background / active tab | `#080a14` |
| Line-number / gutter text | `#4c556b` |
| Inactive tab background | `#151620` |
| Button surface / primary actions / active states | `#1c1e2c` |
...
There is no accent color in this project. `#1c1e2c` is reused as the surface for primary
